...
// in the directory tree Gopkgs, rewriting import statments
...
func rewrite(pkgs []*Package, qual string, paths []string) error {
	...
	return rewriteTree("Gopkgs", qual, paths)
}
...
// path in the Gopkgs src copy of package pkg. If importPath
...
//   C           C
//   fmt         fmt
//   D           C/Gopkgs/_workspace/src/D
//   D/P         C/Gopkgs/_workspace/src/D/P
//   T           C/Gopkgs/_workspace/src/T
